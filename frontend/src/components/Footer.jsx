...
function Footer() {
  ...
  return (
    <footer className="bg-zinc-900 dark:bg-zinc-950 text-zinc-300 border-t border-zinc-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-400 leading-relaxed mb-4">
              Domain Renewal Reminder ensures your business stays online 24/7 with intelligent monitoring and alerts.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/solutions" className="text-sm hover:text-white transition-colors">
                  Solutions
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/documentation" className="text-sm hover:text-white transition-colors">
                  Documentation
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/acceptable-use" className="text-sm hover:text-white transition-colors">
        ...
        <div className="pt-8 border-t border-zinc-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-zinc-400">
              &copy; {currentYear} Domain Renewal Reminder. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <Link to="/sitemap" className="text-sm text-zinc-400 hover:text-white transition-colors">
                Sitemap
              </Link>
              <Link to="/accessibility" className="text-sm text-zinc-400 hover:text-white transition-colors">
                Accessibility
              </Link>
            </div>
          </div>
